...
PyArrayObject *_to_numpy(Scalar *, long rows, long cols);
template<typename Scalar>
PyArrayObject *_to_numpy_copy(const Scalar *, long rows, long cols);

template<>
PyArrayObject *_to_numpy<double>(double *data, long rows, long cols) {
...
template<>
PyArrayObject *_to_numpy<float>(float *data, long rows, long cols) {
...
template<>
PyArrayObject *_to_numpy<long>(long *data, long rows, long cols) {
...
template<>
PyArrayObject *_to_numpy<int>(int *data, long rows, long cols) {
...
template<>
PyArrayObject *_to_numpy<short>(short *data, long rows, long cols) {
...
template<>
PyArrayObject *_to_numpy<char>(char *data, long rows, long cols) {
...
inline PyArrayObject *to_numpy(const Eigen::PlainObjectBase<Derived> &m) {
    ...
    return _to_numpy(m.data(), m.rows(), m.cols());
}
