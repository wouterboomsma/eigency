...
_NDAV(std::complex<long double>, ndarray_complex_long_double_C, ndarray_complex_long_double_F)
_NDAC(std::complex<long double>, ndarray_copy_complex_long_double_C, ndarray_copy_complex_long_double_F)
