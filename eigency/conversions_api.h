...
static PyArrayObject *(*__pyx_api_f_7eigency_11conversions_ndarray_char_C)(char *, long, long, long, long) = 0;
#define ndarray_char_C __pyx_api_f_7eigency_11conversions_ndarray_char_C
static PyArrayObject *(*__pyx_api_f_7eigency_11conversions_ndarray_char_F)(char *, long, long, long, long) = 0;
#define ndarray_char_F __pyx_api_f_7eigency_11conversions_ndarray_char_F
static PyArrayObject *(*__pyx_api_f_7eigency_11conversions_ndarray_copy_char_C)(char const *, long, long, long, long) = 0;
#define ndarray_copy_char_C __pyx_api_f_7eigency_11conversions_ndarray_copy_char_C
static PyArrayObject *(*__pyx_api_f_7eigency_11conversions_ndarray_copy_char_F)(char const *, long, long, long, long) = 0;
#define ndarray_copy_char_F __pyx_api_f_7eigency_11conversions_ndarray_copy_char_F
...
static int import_eigency__conversions(void) {
  ...
  if (__Pyx_ImportFunction(module, "ndarray_char_C", (void (**)(void))&__pyx_api_f_7eigency_11conversions_ndarray_char_C, "PyArrayObject *(char *, long, long, long, long)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "ndarray_char_F", (void (**)(void))&__pyx_api_f_7eigency_11conversions_ndarray_char_F, "PyArrayObject *(char *, long, long, long, long)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "ndarray_copy_char_C", (void (**)(void))&__pyx_api_f_7eigency_11conversions_ndarray_copy_char_C, "PyArrayObject *(char const *, long, long, long, long)") < 0) goto bad;
  if (__Pyx_ImportFunction(module, "ndarray_copy_char_F", (void (**)(void))&__pyx_api_f_7eigency_11conversions_ndarray_copy_char_F, "PyArrayObject *(char const *, long, long, long, long)") < 0) goto bad;
